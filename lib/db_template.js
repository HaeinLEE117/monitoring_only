...
<div id = "line0"></div>
    ...
    for (var i = 0; i < 4; i++) {
      ...
      <a class="car_product" href="Product_Sample.html" target="_blank" style="visibility: ${product[i]}">info</a><a href="./AGV_DATA/0${i + 1}" target="_blank"><img id="car_img" src="src/car${i + 1}.png " />
...
<div id = "line0"></div>
    ...
    for (var i = 0; i < 4; i++) {
      ...
      <a href="./AGV_DATA/0${i + 1}" target="_blank"><img id="car_img" src="src/car${i + 1}.png " />
      <div id="car_text" >${i + 1}호</div><div id="car_state" style="background-color:${vehicle_running[i]}"></div>
      <img src="src/${direction[i]}" style="width: 40px; height: 40px;  position: absolute; left: 10px; top: 30px;" /></a>
  </div>
      `;
